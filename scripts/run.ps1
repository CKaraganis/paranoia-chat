...
docker run -d --name mosquitto-broker -p 1883:1883 -v C:\Users\chris\mosquitto\config:/mosquitto/config -v C:\Users\chris\mosquitto\data:/mosquitto/data -v C:\Users\chris\mosquitto\log:/mosquitto/log eclipse-mosquitto
